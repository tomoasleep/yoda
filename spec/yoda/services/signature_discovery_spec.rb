...
RSpec.describe Yoda::Services::SignatureDiscovery do
  let(:provider) { described_class.from_source(environment: project.environment, source: source, location: location) }
  ...
  describe '#method_candidates' do
    subject { provider.method_candidates }
