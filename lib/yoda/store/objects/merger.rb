        ...
        def merge_attributes(one, another)
          {
            ...
            rbs_type_params_overloads: PendingSet.merge(one[:rbs_type_params_overloads], another[:rbs_type_params_overloads]),
        ...
        def normalize_attributes(attrs)
          {
            ...
            rbs_type_params_overloads: attrs[:rbs_type_params_overloads].to_a,
