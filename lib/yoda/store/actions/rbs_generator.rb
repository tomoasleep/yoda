  ...
  module Store
    module Actions
      class RbsGenerator
          ...
          Dir.chdir(source_dir_path) do
            prepare_dummy_file do |dummy_paths|
              ...
              if import_each
                ...
                rbs_files << convert(source_dir_path)
              end
            end
          end
        ...
        # @param path [String] patch id to generate.
